...
class Validator
{
  ...
  protected $rules_list = ['required', 'min', 'max', 'email', 'match', 'num'];
  protected $messages = [
    'required' => 'Обязательное поле',
    'min' => 'Минимум :rulevalue: символа/символов',
    'max' => 'Максимум :rulevalue: символа/символов',
    'email' => 'Некорректный email',
    'match' => 'Введённые пароли не совпадают',
    'num' => 'Значение должно быть числом'
  ];
